...
- Test coverage gaps where adding the missing tests is engineering-time-bound, not blocked on coordination or data (e.g., missing negative-path tests, missing edge case tests that mirror happy-path structure)
