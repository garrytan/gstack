...
- If the input prompt includes `factory_run_id`, include that exact value as top-level `factory_run_id` in the `gstack-review-log` JSON. If no `factory_run_id` was provided, omit the field.
