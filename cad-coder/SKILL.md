...
Single-part workflow (Phase 1A) keeps writing to `artifacts/<part>.py`
flat. Multi-part lives in its own subdirectory; the two never collide.
...
On every **single-part export turn**, do exactly three things:
