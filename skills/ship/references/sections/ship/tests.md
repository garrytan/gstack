...
**If "Add as P0 TODO":**
- If `TODOS.md` exists, add the entry following the format in `references/artifacts/review/TODOS-format.md` (or `references/artifacts/review/TODOS-format.md`).
...
`$GSTACK_BIN/gstack-detach` instead — it survives in its own
