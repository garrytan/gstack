...
This is a second pass that complements `/ship`'s Step 5.5. Read `references/artifacts/review/TODOS-format.md` (if
...
```bash
NEW_TITLE=$($GSTACK_BIN/gstack-pr-title-rewrite.sh "$V" "$CURRENT_TITLE")
```
