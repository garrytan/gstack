...
**"Design doc saved to: {full path}. Other skills ($plan --mode Product --module plan-ceo-review, $plan --mode Engineering --module plan-eng-review) will find it automatically."**
...
Generated by $plan --mode Discovery --module office-hours on {date}
Branch: {branch}
Repo: {owner/repo}
Status: DRAFT
Mode: Startup
...
(default `$plan --mode Engineering --module plan-eng-review` when ambiguous — it has the broadest real-world use and the
strongest retention).
