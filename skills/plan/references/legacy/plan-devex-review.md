...
<!-- GSTACK2_PROVENANCE source=plan-devex-review/SKILL.md.tmpl base=bb57306d98c97011b0919c6132705a15b1579781 blob=1ef723c10997a08ef87940daceb08bf8d60dd810 baseline_render_sha256=4f77b2fb446e9a79ac5027ab14d097b48d62435d162900d2471e5fa19a0a4605 ported_render_sha256=5be964b8b6e8ddf87df7b44bb7713e0c31a3de32cf261682793bc7db45c7cba1 disposition=BUG_FIX -->
...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"plan-devex-review","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z0-9._-'); echo "${_repo:-unknown}")'"}'  >> "${GSTACK_HOME:-$HOME/.gstack}"/analytics/skill-usage.jsonl 2>/dev/null || true
fi
