...
<!-- GSTACK2_PROVENANCE source=sync-gbrain/SKILL.md.tmpl base=bb57306d98c97011b0919c6132705a15b1579781 blob=2ec065472e263a07f3818ed87ee9a6a2e13ca3ae baseline_render_sha256=8f58e6f0dcf18968590db858c7e3f1050d1729cacc573430df6f18bffaee74bf ported_render_sha256=b33fb4a5fadaf6bcf71363b4e8d9b1f3fd56336f47d23eb8e8594d534d76b55b disposition=BUG_FIX -->
...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"sync-gbrain","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z0-9._-'); echo "${_repo:-unknown}")'"}'  >> "${GSTACK_HOME:-$HOME/.gstack}"/analytics/skill-usage.jsonl 2>/dev/null || true
fi
...
gbrain status: GREEN
  ...
  "${GSTACK_HOME:-$HOME/.gstack}" source. OK   <gstack-brain-{user}> (page_count=<N>) — managed by /setup-gbrain
