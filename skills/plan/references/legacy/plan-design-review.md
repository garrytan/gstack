...
<!-- GSTACK2_PROVENANCE source=plan-design-review/SKILL.md.tmpl base=bb57306d98c97011b0919c6132705a15b1579781 blob=7178c991e41277410de500298cf81372543861af baseline_render_sha256=7dfab0ea92c44ae6d6ebc36353cec4ebd56331d2740e0e2138c5cdc922ee53a7 ported_render_sha256=05fdb5d63dc6007307c74493f0597251fb9d203b310f7c80b5921b94666f3d99 disposition=BUG_FIX -->
...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"plan-design-review","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z0-9._-'); echo "${_repo:-unknown}")'"}'  >> "${GSTACK_HOME:-$HOME/.gstack}"/analytics/skill-usage.jsonl 2>/dev/null || true
fi
