...
<!-- GSTACK2_PROVENANCE source=claude/SKILL.md.tmpl base=bb57306d98c97011b0919c6132705a15b1579781 blob=94552cbe4efebc908f70f03880e584879db80aca baseline_render_sha256=84d3c192d21b202225f3d6d3a2a9bae133acd16aac6529e3237f14a76b831384 ported_render_sha256=f8b5964bf630d0716ad5cfd729f6d4e62bb89d4eab64a210090fb0e875f0b59d disposition=BUG_FIX -->
<!-- GSTACK2_ROUTING replacement=$review --mode Deep --module claude visibility=primary depth=standard mutation=report-only web=none -->

<!-- GSTACK2_LEGACY_BODY_START source=claude -->
## Preamble (run first)
...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"claude","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z0-9._-'); echo "${_repo:-unknown}")'"}'  >> "${GSTACK_HOME:-$HOME/.gstack}"/analytics/skill-usage.jsonl 2>/dev/null || true
fi
...
<!-- GSTACK2_LEGACY_BODY_END source=claude -->
