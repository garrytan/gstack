...
<!-- GSTACK2_PROVENANCE source=health/SKILL.md.tmpl base=bb57306d98c97011b0919c6132705a15b1579781 blob=f92eb7347ec4f77dd8dbf464d63fcdf6a3459908 baseline_render_sha256=34884311c30b46d7dbb814d4ccd238c6ca74a9fe54f9df50bbb2838a340be4d9 ported_render_sha256=3e478e5673d54ce0e227e589ab0800bd14de65cb8df4e12661e330b57018465c disposition=BUG_FIX -->
...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"health","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z0-9._-'); echo "${_repo:-unknown}")'"}'  >> "${GSTACK_HOME:-$HOME/.gstack}"/analytics/skill-usage.jsonl 2>/dev/null || true
fi
