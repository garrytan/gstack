...
Resolve these paths relative to `skills/review/`. Files come from base bb57306d98c97011b0919c6132705a15b1579781; `MECHANICAL_PORT` changes only host/runtime path mechanics and records both hashes in provenance.
...
| `review/specialists/maintainability.md` | `references/artifacts/review/specialists/maintainability.md` | `VERBATIM_PORT` | `a2a036f9ca4c77ea4d9b9b38233444772a9eccfc` |
| `review/specialists/performance.md` | `references/artifacts/review/specialists/performance.md` | `VERBATIM_PORT` | `612aa285d69a3c73da37e766a8da6de489c41a6d` |
