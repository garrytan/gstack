...
Resolve these paths relative to `skills/qa/`. Files come from base bb57306d98c97011b0919c6132705a15b1579781; `MECHANICAL_PORT` changes only host/runtime path mechanics and records both hashes in provenance.
...
| `qa/references/issue-taxonomy.md` | `references/artifacts/qa/references/issue-taxonomy.md` | `VERBATIM_PORT` | `05c574166b469352301664cd02320a1ce1d65b41` |
| `qa/templates/qa-report-template.md` | `references/artifacts/qa/templates/qa-report-template.md` | `VERBATIM_PORT` | `6aa30943392b75ca8fb8694be31edf89881afd92` |
