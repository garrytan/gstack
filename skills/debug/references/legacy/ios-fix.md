...
<!-- GSTACK2_PROVENANCE source=ios-fix/SKILL.md.tmpl base=bb57306d98c97011b0919c6132705a15b1579781 blob=94655e282f535b846eada11143e95df58d29263b baseline_render_sha256=63b49ec3aa3b9894a20dfee4d4454bd9d2505dafd74ae1c8f1d6c2cb2db07b90 ported_render_sha256=1a94ad8852821684d4806b10c5464f7adef80cb28817800f1e88dfe808f0a26d disposition=BUG_FIX -->
<!-- GSTACK2_ROUTING replacement=$debug --mode Fix --module ios-fix visibility=primary depth=deep mutation=fix-safe web=none -->

<!-- GSTACK2_LEGACY_BODY_START source=ios-fix -->
## Preamble (run first)
...
if [ "$_TEL" != "off" ]; then
echo '{"skill":"ios-fix","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","repo":"'$(_repo=$(basename "$(git rev-parse --show-toplevel 2>/dev/null)" 2>/dev/null | tr -cd 'a-zA-Z0-9._-'); echo "${_repo:-unknown}")'"}'  >> "${GSTACK_HOME:-$HOME/.gstack}"/analytics/skill-usage.jsonl 2>/dev/null || true
fi
...
<!-- GSTACK2_LEGACY_BODY_END source=ios-fix -->
