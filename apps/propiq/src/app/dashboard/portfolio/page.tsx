...
export const metadata: Metadata = {
  title: PLACEHOLDER_COPY.portfolio.title,
...
export default function Page() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <h1 className="text-2xl font-semibold tracking-tight">{PLACEHOLDER_COPY.portfolio.title}</h1>
      <RoadmapNotice section="portfolio" />
      <Link
        href="/dashboard"
