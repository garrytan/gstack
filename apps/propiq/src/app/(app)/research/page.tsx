  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <p className="mt-3 max-w-2xl text-[var(--text-secondary)]">
        How the scoring works, what backs each figure, and the guides behind the free tools.
        Market reports arrive when there is real market data to report on — until then this index
        only lists what has actually been written.
      </p>
