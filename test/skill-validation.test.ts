...
describe('ship step numbering', () => {
  ...
  // 9.2 (Findings Merge), 9.3 (Cross-review dedup), 15.0 (WIP squash —
  // continuous checkpoint), 15.1 (Bisectable commits).
  const ALLOWED_SUBSTEPS = new Set(['0.9', '1.5', '8.1', '8.2', '9.1', '9.2', '9.3', '15.0', '15.1']);
