...
`.gbrain/skills/gstack/`. Vendoring is deprecated. We will not keep vendored copies
...
section, run `~/.gbrain/skills/gstack/bin/gstack-review-read` and append a report.
