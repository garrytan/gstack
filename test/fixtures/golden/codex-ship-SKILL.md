...
_EXPLAIN_LEVEL="${EXPLAIN_LEVEL:-$($GSTACK_BIN/gstack-config get explain_level 2>/dev/null || echo "default")}"
if [ "$_EXPLAIN_LEVEL" != "default" ] && [ "$_EXPLAIN_LEVEL" != "terse" ]; then _EXPLAIN_LEVEL="default"; fi
echo "EXPLAIN_LEVEL: $_EXPLAIN_LEVEL"
_QUESTION_TUNING="${QUESTION_TUNING:-$($GSTACK_BIN/gstack-config get question_tuning 2>/dev/null || echo "false")}"
