...
export const SKILL_COVERAGE: Record<string, SkillCoverage> = {
  ...
  fanout: {
    ...
    periodic: [],
    rationale: 'v0 produces a markdown section + bash script; behavior is deterministic given input doc structure. fanout.test.ts pins frontmatter and core section invariants.',
  },
