...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  // gstack-upgrade
  'gstack-upgrade-happy-path': ['gstack-upgrade/**', 'test/helpers/session-runner.ts'],
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'gstack-upgrade/SKILL.md upgrade flow': ['gstack-upgrade/SKILL.md', 'gstack-upgrade/SKILL.md.tmpl', 'scripts/host-registry.ts'],
};
