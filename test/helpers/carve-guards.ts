...
export const CARVE_GUARDS: Record<string, CarveGuard> = {
  ...
  'document-release': {
    ...
    // to match while the skeleton budget stays tight on the always-loaded
    // cost flat.
    maxSizeRatio: 1.20,
  },
  'design-consultation': {
