...
Read CLAW.md and look for a `## Health Stack` section. If found, parse the tools
...
A) Looks right -- persist to CLAW.md and continue
...
3. **Respect CLAW.md.** If `## Health Stack` is configured, use those exact commands. Do not second-guess.
