...
```bash
~/.claw/skills/gstack/bin/gstack-brain-init
~/.claw/skills/gstack/bin/gstack-config set gbrain_sync_mode artifacts-only
...
Find-and-replace (or append) this section in CLAW.md:
