...
```bash
DISCOVER_BIN=""
[ -x ~/.claw/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.claw/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .claw/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.claw/skills/gstack/bin/gstack-global-discover
...
- Do not read CLAW.md or other docs — this skill is self-contained
