...
3. **Queue-aware version pick (workspace-aware ship, v1.6.4.0+).** Call `$GSTACK_BIN/gstack-next-version` to see what's already claimed by open PRs + active sibling Conductor worktrees, then render the queue state to the user:
