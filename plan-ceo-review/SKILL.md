...
Feed into the Premise Challenge (0A) and Dream State Mapping (0C). If you find a first-principles insight, surface it during the Expansion opt-in ceremony as a differentiation opportunity.
...
depends on this local data. Skipping this command breaks the review readiness
dashboard in /ship.
