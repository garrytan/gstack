...
`~/.claude/skills/gstack/docs/shared-conduct.md`. Read it now with the Read
...
Read `GSTACK_PLAN_MODE` from the environment (emitted by the preamble bash
at the top of this skill). Then:
