...
Generates a comprehensive engineering retrospective analyzing commit history, work patterns, and code quality metrics. Team-aware: identifies the user running the command, then analyzes every contributor with per-person praise and growth opportunities. Designed for a senior IC/CTO-level builder using Antigravity Code as a force multiplier.
...
**AI collaboration note:** If many commits have `Co-Authored-By` AI trailers (e.g., Antigravity, Copilot), note the AI-assisted commit percentage as a team metric. Frame it neutrally — "N% of commits were AI-assisted" — without judgment.
...
```bash
DISCOVER_BIN=""
[ -x ~/.antigravity/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.antigravity/skills/gstack/bin/gstack-global-discover
...
- Behavioral patterns (e.g., "Antigravity used exclusively for myapp, Antigravity Code for everything else")
...
║  [N] AI coding sessions (CC: X, Antigravity: Y, Gemini: Z)
...
| Total LOC | +N / -N |
| AI coding sessions | N (CC: X, Antigravity: Y, Gemini: Z) |
| Active days | N |
...
- Antigravity Code: N sessions across M repos — patterns observed
- Antigravity: N sessions across M repos — patterns observed
  ...
  "projects": [
    {
      ...
      "insertions": 3200,
      "deletions": 800,
      "sessions": { "antigravity_code": 15, "antigravity": 3, "gemini": 0 }
    }
  ],
  "totals": {
    "commits": 182,
    ...
    "projects": 5,
    "active_days": 6,
    "sessions": { "antigravity_code": 48, "antigravity": 8, "gemini": 3 },
    "global_streak_days": 52,
    "avg_context_switches_per_day": 2.1
  },
  "tweetable": "Week of Mar 14: 5 projects, 182 commits, 15.3k LOC | CC: 48, Antigravity: 8, Gemini: 3 | Focus: gstack (58%) | Streak: 52d"
}
```
