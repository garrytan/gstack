...
```bash
DISCOVER_BIN=""
[ -x ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/gstack/bin/gstack-global-discover
