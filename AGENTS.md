...
| `/gloop` | Goal loop. Clarifies a goal into success criteria, reviews the plan (`/autoplan` or `/plan-eng-review`), implements in scoped passes, runs tests + `/review` after each, loops until PR-ready or blocked. |
