...
const codex: HostConfig = {
  ...
  pathRewrites: [
    { from: '~/.claude/skills/gstack/review/checklist.md', to: '$GSTACK_ROOT/review/checklist.md', dependency: { destination: 'review/checklist.md', kind: 'file' } },
    { from: '.claude/skills/review/checklist.md', to: '$GSTACK_ROOT/review/checklist.md', dependency: { destination: 'review/checklist.md', kind: 'file' } },
    { from: '~/.claude/skills/gstack/review/design-checklist.md', to: '$GSTACK_ROOT/review/design-checklist.md', dependency: { destination: 'review/design-checklist.md', kind: 'file' } },
    { from: '.claude/skills/review/design-checklist.md', to: '$GSTACK_ROOT/review/design-checklist.md', dependency: { destination: 'review/design-checklist.md', kind: 'file' } },
    { from: '~/.claude/skills/gstack/review/greptile-triage.md', to: '$GSTACK_ROOT/review/greptile-triage.md', dependency: { destination: 'review/greptile-triage.md', kind: 'file' } },
    { from: '.claude/skills/review/greptile-triage.md', to: '$GSTACK_ROOT/review/greptile-triage.md', dependency: { destination: 'review/greptile-triage.md', kind: 'file' } },
    { from: '~/.claude/skills/gstack/review/TODOS-format.md', to: '$GSTACK_ROOT/review/TODOS-format.md', dependency: { destination: 'review/TODOS-format.md', kind: 'file' } },
    { from: '.claude/skills/review/TODOS-format.md', to: '$GSTACK_ROOT/review/TODOS-format.md', dependency: { destination: 'review/TODOS-format.md', kind: 'file' } },
    { from: '~/.claude/skills/gstack/lib/jsonl-store.ts', to: '$GSTACK_ROOT/lib/jsonl-store.ts', dependency: { destination: 'lib/jsonl-store.ts', kind: 'library' } },
    { from: '~/.claude/skills/gstack/lib/redact-audit-log.ts', to: '$GSTACK_ROOT/lib/redact-audit-log.ts', dependency: { destination: 'lib/redact-audit-log.ts', kind: 'library' } },
    { from: '~/.claude/skills/gstack/bin', to: '$GSTACK_ROOT/bin', dependency: { destination: 'bin', kind: 'executable' } },
    { from: '~/.claude/skills/gstack/browse/bin', to: '$GSTACK_ROOT/browse/bin', dependency: { destination: 'browse/bin', kind: 'executable' } },
    { from: '~/.claude/skills/gstack/browse/dist', to: '$GSTACK_ROOT/browse/dist', dependency: { destination: 'browse/dist', kind: 'executable' } },
    { from: '~/.claude/skills/gstack/design/dist', to: '$GSTACK_ROOT/design/dist', dependency: { destination: 'design/dist', kind: 'executable' } },
    { from: '~/.claude/skills/gstack/make-pdf/dist', to: '$GSTACK_ROOT/make-pdf/dist', dependency: { destination: 'make-pdf/dist', kind: 'executable' } },
    { from: '~/.claude/skills/gstack/design-html/vendor/pretext.js', to: '$GSTACK_ROOT/design-html/vendor/pretext.js', dependency: { destination: 'design-html/vendor/pretext.js', kind: 'file' } },
    { from: '~/.claude/skills/gstack/scripts/jargon-list.json', to: '$GSTACK_ROOT/scripts/jargon-list.json', dependency: { destination: 'scripts/jargon-list.json', kind: 'file' } },
    { from: '~/.claude/skills/gstack/plan-devex-review/dx-hall-of-fame.md', to: '$GSTACK_ROOT/plan-devex-review/dx-hall-of-fame.md', dependency: { destination: 'plan-devex-review/dx-hall-of-fame.md', kind: 'file' } },
    { from: '~/.claude/skills/gstack/gstack-upgrade/SKILL.md', to: '$GSTACK_ROOT/gstack-upgrade/SKILL.md', dependency: { destination: 'gstack-upgrade/SKILL.md', kind: 'file' } },
    { from: '~/.claude/skills/gstack/ETHOS.md', to: '$GSTACK_ROOT/ETHOS.md', dependency: { destination: 'ETHOS.md', kind: 'file' } },
    { from: '~/.claude/skills/gstack/VERSION', to: '$GSTACK_ROOT/VERSION', dependency: { destination: 'VERSION', kind: 'file' } },
    ...['office-hours', 'plan-ceo-review', 'plan-design-review', 'plan-devex-review', 'plan-eng-review'].map(skill => ({
      from: `~/.claude/skills/gstack/${skill}/SKILL.md`, to: `$GSTACK_SKILLS_DIR/gstack-${skill}/SKILL.md`,
      dependency: { destination: `gstack-${skill}/SKILL.md`, kind: 'generated-entrypoint' as const },
    })),
