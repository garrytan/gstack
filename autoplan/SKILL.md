...
- Discover design docs: if plan mode exposes an active plan file and it looks like an
  `/office-hours` design doc, use that first. Otherwise fall back to
  `ls -t ~/.gstack/projects/$SLUG/*-design-*.md 2>/dev/null | head -1`
