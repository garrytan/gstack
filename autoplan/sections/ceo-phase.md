...
Before dispatch, fully Read `methodologyPath` from `bun "<SNAPSHOT_TOOL>" methodology ceo "<REVIEW_SKILL>" "<RESTORE_PATH>"`; log successful start/end/total; fill gaps to EOF. Skip-listed: load only.
