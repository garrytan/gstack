...
Before dispatch, fully Read `~/.claude/skills/gstack/plan-devex-review/SKILL.md` and `sections/review-sections.md` beside it; log successful start/end/total; fill gaps to EOF. Skip-listed: load only.
