...
- Competitive benchmark: research through Aside per the loaded skill's "Web research runs in Aside" section when its probe prints `READY`; use the reference benchmarks otherwise (P1)
