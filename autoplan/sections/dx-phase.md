...
Before dispatch, fully Read `~/.claude/skills/gstack/plan-devex-review/SKILL.md` + triggered sections; record successful start/end/total ranges; fill gaps to EOF. Load skip-listed sections; skip execution.
