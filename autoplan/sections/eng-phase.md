...
Before dispatch, fully Read `~/.claude/skills/gstack/plan-eng-review/SKILL.md` + triggered sections; record successful start/end/total ranges; fill gaps to EOF. Load skip-listed sections; skip execution.
...
Only then announce completion and proceed to final synthesis/approval:
