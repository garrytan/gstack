...
---
<!-- Generated by scripts/gen-cursor-native.ts from freeze/SKILL.md.tmpl — do not edit directly -->
...
Ask the user which directory to restrict edits to. Use AskQuestion:
...
- Freeze applies to Edit and Write tools only — Read, Shell, Glob, Grep are unaffected
