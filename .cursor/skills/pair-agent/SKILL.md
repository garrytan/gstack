...
---
<!-- Generated by scripts/gen-cursor-native.ts from pair-agent/SKILL.md.tmpl — do not edit directly -->
...
If the value is not `on`, ask via AskQuestion (one-way-door posture —
