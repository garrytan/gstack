...
---
<!-- Generated by scripts/gen-cursor-native.ts from context-restore/SKILL.md.tmpl — do not edit directly -->
...
After presenting, ask via AskQuestion:
...
- **This is a gstack skill, not a Claude Code built-in.** When the user types
  `/context-restore`, invoke this skill by reading `.cursor/skills/<name>/SKILL.md`.
