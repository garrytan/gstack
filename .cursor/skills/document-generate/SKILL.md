...
---
<!-- Generated by scripts/gen-cursor-native.ts from document-generate/SKILL.md.tmpl — do not edit directly -->
...
2. Use AskQuestion to confirm scope and ask about documentation target:
...
If the plan has more than 5 documents to create, use AskQuestion to confirm before proceeding.
