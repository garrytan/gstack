...
---
<!-- Generated by scripts/gen-cursor-native.ts from plan-devex-review/SKILL.md.tmpl — do not edit directly -->
...
\`.cursor/skills/plan-devex-review/dx-hall-of-fame.md\`
...
|------|-------------------|
| running the 8 DX passes, required outputs, and review report (only after Step 0 investigation is complete) | `$GSTACK_ROOT/plan-devex-review/sections/review-sections.md` |
---
...
Then SHOW it to the user via AskQuestion:
...
3. **AskQuestion per friction point.** One question per friction point found.
...
7. AskQuestion if there's a genuine DX choice to resolve
...
- **DX EXPANSION:** After fixing to 10, also ask "What would make this dimension
  ...
  individual opt-in AskQuestions.
...
> **STOP.** Before running the 8 DX passes, required outputs, and review report (only after Step 0 investigation is complete), Read `plan-devex-review/sections/review-sections.md` and execute it
> in full. Do not work from memory — that section is the source of truth for this step.

## Section self-check (before you finish)

Confirm you Read the review section the Section index named, and executed all 8 DX passes, the required outputs, and the review report in full. If you produced findings or the review report from memory without Reading `$GSTACK_ROOT/plan-devex-review/sections/review-sections.md`, stop and Read it now.
