...
---
<!-- Generated by scripts/gen-cursor-native.ts from design-shotgun/SKILL.md.tmpl — do not edit directly -->
...
**AskQuestion with pre-filled context:** Pre-fill what you inferred from the codebase,
...
Use AskQuestion to confirm before spending API credits:
...
After receiving feedback (via HTTP POST or AskQuestion fallback), output a clear
...
Use AskQuestion to confirm before saving.
...
If standalone, offer next steps via AskQuestion:
