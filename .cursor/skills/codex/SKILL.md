...
---
<!-- Generated by scripts/gen-cursor-native.ts from codex/SKILL.md.tmpl — do not edit directly -->
...
3. `/codex` with no arguments — **Auto-detect:**
   ...
   - If a diff exists, use AskQuestion:
     ```
...
user should do, in the canonical format the AskQuestion judge grades:
...
should do, in the canonical format the AskQuestion judge grades:
...
If a session file exists (not `NO_SESSION`), use AskQuestion:
```
...
canonical format the AskQuestion judge grades:
