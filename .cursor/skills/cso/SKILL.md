...
---
<!-- Generated by scripts/gen-cursor-native.ts from cso/SKILL.md.tmpl — do not edit directly -->
...
|------|-------------------|
| running the scope-dependent audit phases (Phases 2-11) selected by the resolved mode, after the Phase 0 stack detection and Phase 1 attack-surface census | `$GSTACK_ROOT/cso/sections/audit-phases.md` |
---
...
> **STOP.** Before running the scope-dependent audit phases (Phases 2-11) selected by the resolved mode, after the Phase 0 stack detection and Phase 1 attack-surface census, Read `cso/sections/audit-phases.md` and execute it
...
**Remediation Roadmap:** For the top 5 findings, present via AskQuestion:
