...
---
<!-- Generated by scripts/gen-cursor-native.ts from document-release/SKILL.md.tmpl — do not edit directly -->
...
- Bump VERSION without asking — always use AskQuestion for version changes
...
|------|-------------------|
| auditing each doc file and applying updates, polishing CHANGELOG voice, checking cross-doc consistency, cleaning up TODOS, the VERSION bump, and committing (Steps 2-9, after the coverage map in Step 1.5) | `$GSTACK_ROOT/document-release/sections/release-body.md` |
...
> **STOP.** Before auditing each doc file and applying updates, polishing CHANGELOG voice, checking cross-doc consistency, cleaning up TODOS, the VERSION bump, and committing (Steps 2-9, after the coverage map in Step 1.5), Read `document-release/sections/release-body.md` and execute it
