...
~/.gemini/antigravity/skills/bin/gstack-timeline-log '{"skill":"connect-chrome","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.gemini/antigravity/skills/extension/manifest.json" ] && _EXT_PATH="$_ROOT/.gemini/antigravity/skills/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/.gemini/antigravity/skills/extension/manifest.json" ] && _EXT_PATH="$HOME/.gemini/antigravity/skills/extension"
