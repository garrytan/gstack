...
~/.gemini/antigravity/skills/bin/gstack-timeline-log '{"skill":"canary","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
```bash
eval "$(~/.gemini/antigravity/skills/bin/gstack-slug 2>/dev/null || echo "SLUG=unknown")"
