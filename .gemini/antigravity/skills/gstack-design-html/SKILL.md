...
~/.gemini/antigravity/skills/bin/gstack-timeline-log '{"skill":"design-html","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
_PRETEXT_VENDOR=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.gemini/antigravity/skills/design-html/vendor/pretext.js" ] && _PRETEXT_VENDOR="$_ROOT/.gemini/antigravity/skills/design-html/vendor/pretext.js"
[ -z "$_PRETEXT_VENDOR" ] && [ -f ~/.gemini/antigravity/skills/design-html/vendor/pretext.js ] && _PRETEXT_VENDOR=~/.gemini/antigravity/skills/design-html/vendor/pretext.js
