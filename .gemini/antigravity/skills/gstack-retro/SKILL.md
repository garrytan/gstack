...
~/.gemini/antigravity/skills/bin/gstack-timeline-log '{"skill":"retro","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
```bash
~/.gemini/antigravity/skills/bin/gstack-learnings-log '{"skill":"retro","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
...
```bash
DISCOVER_BIN=""
[ -x ~/.gemini/antigravity/skills/bin/gstack-global-discover ] && DISCOVER_BIN=~/.gemini/antigravity/skills/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .gemini/antigravity/skills/bin/gstack-global-discover ] && DISCOVER_BIN=.gemini/antigravity/skills/bin/gstack-global-discover
