...
${codexPreflight(ctx, { disabledBehavior: 'codex-only' })}
...
${codexPreflight(ctx, { disabledBehavior: 'skip-all' })}
...
**Persist the result:**
\`\`\`bash
${ctx.paths.binDir}/gstack-review-log '{"skill":"codex-plan-review","timestamp":"'"$(date -u +%Y-%m-%dT%H:%M:%SZ)"'","status":"STATUS","source":"SOURCE","commit":"'"$(git rev-parse --short HEAD)"'"}'
\`\`\`
...
**Persist the result:**
\`\`\`bash
${ctx.paths.binDir}/gstack-review-log '{"skill":"codex-doc-review","timestamp":"'"$(date -u +%Y-%m-%dT%H:%M:%SZ)"'","status":"STATUS","source":"SOURCE","commit":"'"$(git rev-parse --short HEAD)"'"}'
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/gstack-learnings-log '{
  "type": "pitfall",
