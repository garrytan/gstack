...
import { generateReviewDashboard, generatePlanFileReviewReport, generateSpecReviewLoop, generateBenefitsFrom, generateAntigravitySecondOpinion, generateAdversarialStep, generateAntigravityPlanReview, generatePlanCompletionAuditShip, generatePlanCompletionAuditReview, generatePlanVerificationExec, generateScopeDrift } from './review';
...
export const RESOLVERS: Record<string, ResolverFn> = {
  ...
  CODEX_SECOND_OPINION: generateAntigravitySecondOpinion,
  ADVERSARIAL_STEP: generateAdversarialStep,
  SCOPE_DRIFT: generateScopeDrift,
  DEPLOY_BOOTSTRAP: generateDeployBootstrap,
  CODEX_PLAN_REVIEW: generateAntigravityPlanReview,
