...
async function main() {
  ...
  try {
    ...
    console.log(`   - Windows (x64): node scripts/build-binaries.js`);
    console.log(`   - macOS ARM64: node scripts/build-binaries.js`);
    console.log(`   - macOS Intel: node scripts/build-binaries.js`);
    console.log(`   - Linux (x64): node scripts/build-binaries.js`);
