...
| `/deck` | **Deck Builder** | Add or seriously redesign an interactive web deck on an existing site. Learns the real product first, asks only the unanswered investor-grade questions, then ships an evidence-led story with accessible deep links, mobile layouts, visual QA, and a controlled release gate. |
