...
| `/document-release` | **Technical Writer** | Update all project docs to match what you just shipped. Catches stale READMEs automatically. Also audits in-app public docs sites (Next.js/Docusaurus/Mintlify/VitePress/Nextra page trees), not just root markdown. Builds a Diataxis coverage map (reference / how-to / tutorial / explanation) so gaps are visible in the PR body. |
