...
| `/implement` | **Implementation Lead** | Delegate plan → code to OpenAI Codex. Runs `codex exec` in the background on a cc worktree, polls progress, then auto-runs `/codex review` + `/review` as a gate. |
