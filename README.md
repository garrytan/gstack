...
**gstack is how I do it.** It turns Claude Code into a virtual engineering team — a CEO who rethinks the product, an eng manager who locks architecture, a designer who catches AI slop, a reviewer who finds production bugs, a QA lead who opens a real browser, a security officer who runs OWASP + STRIDE audits, and a release engineer who ships the PR. Twenty-six specialists and eight power tools, all slash commands, all Markdown, all free, MIT license.
...
| `/context-compress` | **Context Compression** | Turn repeated prompts, domain rules, examples, and human feedback into compact local Context Cards. Approval-gated and redacted by default. |
| `/trace-to-train` | **Trace Steward** | Convert human-approved runs into redacted TraceRecords, eval candidates, and optional JSONL examples for future model-agnostic SLM experiments. |
| `/data-review` | **Data Reviewer** | Review data-heavy work for schema drift, leakage, assumptions, bias, reproducibility, misleading charts, PII, and domain-specific risk. |
...
| [Vertical Intelligence Flywheel](docs/vertical-intelligence-flywheel.md) | Local-first context cards, redacted traces, evals, and training-ready artifacts for vertical workflows |
...
/learn, /context-compress, /trace-to-train, /data-review.
```
