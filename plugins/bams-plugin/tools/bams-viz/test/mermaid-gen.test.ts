...
describe('generateFlowchart', () => {
  ...
  test('parallel agents create fork node', () => {
    const result = generateFlowchart(makePipeline({
      ...
      agents: [
        { callId: 'a1', agentType: 'frontend-engineering', model: 'claude-opus-4-7', stepNumber: 1, durationMs: 8000, startedAt: '2026-04-03T10:00:00Z', endedAt: '2026-04-03T10:00:08Z', isError: false, description: '', promptSummary: '', parallelGroup: null, department: 'engineering' },
        { callId: 'a2', agentType: 'backend-engineering', model: 'claude-opus-4-7', stepNumber: 1, durationMs: 10000, startedAt: '2026-04-03T10:00:00Z', endedAt: '2026-04-03T10:00:10Z', isError: false, description: '', promptSummary: '', parallelGroup: null, department: 'engineering' },
      ],
    }))
...
describe('generateGantt', () => {
  ...
  test('step with agents shows agent bars', () => {
    const result = generateGantt(makePipeline({
      steps: [{ number: 1, name: 'Build', phase: 'Phase 1', status: 'done', durationMs: 5000, startedAt: '2026-04-03T10:00:00Z', endedAt: '2026-04-03T10:00:05Z', agentCallIds: [] }],
      agents: [
        { callId: 'a1', agentType: 'frontend-engineering', model: 'claude-opus-4-7', stepNumber: 1, durationMs: 5000, startedAt: '2026-04-03T10:00:00Z', endedAt: '2026-04-03T10:00:05Z', isError: false, description: '', promptSummary: '', parallelGroup: null, department: 'engineering' },
      ],
    }))
    expect(result).toContain('frontend-engineering (claude-opus-4-7)')
