...
description: |
  ...
  One command: connects Antigravity to a visible Chrome window where you can watch every
...
Connect Antigravity to a visible Chrome window with the gstack extension auto-loaded.
...
commands appear in the activity feed. Every command Antigravity runs shows up here
in real time."
...
> snapshot and describe this page." A sidebar agent (a child Antigravity instance)
...
> it won't interfere with this Antigravity Code window.
...
>
> **Watch Antigravity work in real time:**
