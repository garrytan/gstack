...
```bash
~/.antigravity/skills/gstack/bin/gstack-review-read 2>/dev/null
```
...
plan-design-review, design-review-lite, antigravity-review, review, adversarial-review,
...
**Also check for adversarial review (`antigravity-review`).** If antigravity-review has been run
...
```bash
cat ~/.antigravity/skills/gstack/review/checklist.md 2>/dev/null || echo "Checklist not found"
```
...
║  └─ Antigravity Review:  CURRENT / — (optional)                ║
║                                                          ║
║  TESTS                                                   ║
...
```bash
eval $(~/.antigravity/skills/gstack/bin/gstack-diff-scope $(gh pr view --json baseRefName -q .baseRefName 2>/dev/null || echo main) 2>/dev/null)
