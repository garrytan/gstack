...
export const COMMAND_DESCRIPTIONS: Record<string, { category: string; description: string; usage?: string }> = {
  ...
  'cookie-import-browser': { category: 'Interaction', description: 'Import browser cookies with domain-aware profile selection, bounded retry, and optional auth verification', usage: 'cookie-import-browser [browser] [--domain d] [--profile p] [--verify-auth]' },
