...
| `cookie-import-browser [browser] [--domain d] [--profile p] [--verify-auth]` | Import browser cookies with domain-aware profile selection, bounded retry, and optional auth verification |
