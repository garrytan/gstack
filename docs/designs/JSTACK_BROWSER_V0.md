...
**Branch:** JerkyJesse/jstack-as-browser
...
A double-clickable macOS .app that wraps Playwright's Chromium with the jstack
...
Every jstack skill becomes a browser capability.
...
| `JSTACK_CHROMIUM_PATH` | **SHIPPED** | Custom Chromium binary support |
