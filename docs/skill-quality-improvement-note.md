...
Neutralizes instruction patterns in autoplan/SKILL.md that could override higher-priority constraints.

## Detection

- Repository: garrytan/gstack
- File: autoplan/SKILL.md
...
garrytan/gstack appears to have a broad downstream surface, so this patch is intentionally narrow and review-friendly.
