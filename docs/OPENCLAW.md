...
These skills (`openclaw/skills/gstack-openclaw-*/SKILL.md`) are hand-crafted methodology
skills (not generated by the pipeline). The publish command is `clawhub publish` (NOT
