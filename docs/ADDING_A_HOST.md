# Adding a New Host to jstack

jstack uses a declarative host config system. Each supported AI coding agent
...
const myhost: HostConfig = {
  ...
  globalRoot: '.myhost/skills/jstack',
  localSkillRoot: '.myhost/skills/jstack',
  hostSubdir: '.myhost',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/jstack', to: '~/.myhost/skills/jstack' },
    { from: '.claude/skills/jstack', to: '.myhost/skills/jstack' },
...
ls .myhost/skills/jstack-*/SKILL.md
